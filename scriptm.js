...
function peticionGet(){
  ...
  function peticionPost1() {
    ...
    $.ajax({
        method: "POST",
        url: "http://144.22.59.230:8080/api/Message/save",
        data: datasend,
        dataType: 'json',
        ...
        error: function (error) {
                ...
                function actualizar1(){
                    ...
                    $.ajax({
                          ...
                          data:dataToSend,
                          contentType:'application/json',
                          url:"http://144.22.59.230:8080/api/Message/update",
                          method:'PUT',   
